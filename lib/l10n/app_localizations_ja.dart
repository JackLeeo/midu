...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get bookSourcesNoSourcesDescription =>
      '米読ソースプロトコル に対応したサービスのアドレスを貼り付けて接続します。';
  ...
  String get bookSourcesNoOfficialSourcesNotice =>
      'MiDu は書籍ソースをプリインストールせず、サードパーティサービスを運営、推奨、保証しません。すべてのアドレスはあなたが追加します。';
  ...
  @override
  String get bookSourcesProtocolTitle => '米読ソースプロトコル';
  ...
  String get bookSourcesRightsUnverifiedNotice =>
      'これらの情報は独立したソース運営者による自己申告です。MiDu は透明性のために表示しますが、検証、推奨、保証は行いません。';
  ...
  @override
  String get fontPreviewText => '米読 · 自由に読む 開卷有益';
  ...
  @override
  String get settingsQqChannelSubtitle => '米読';
  ...
  @override
  String get agreementWelcomeTitle => 'MiDu へようこそ';
  ...
  @override
  String get firstHomeSupportPaperSemanticLabel => '米読の開発者からの任意支援についての手紙';
  ...
  String get settingsSupportDevelopmentCardSubtitle =>
      '開発と保守には多くの時間と労力がかかっています。米読が役に立った場合は、任意の寄付で支援いただけます。';
  ...
  String get openSourceLicensesIntro =>
      '以下のライセンス文はアプリ内でオフライン表示できます。米読、内蔵フォント、サードパーティソフトウェアには、それぞれのライセンスが適用されます。';
  ...
  String get openSourceLicenseLegalese =>
      '米読 とサードパーティコンポーネントには、それぞれのライセンスが適用されます。';
  ...
  @override
  String get contributorsSubtitle => '米読 をより良くしてくれるすべての人に感謝します';
  ...
  String get settingsOfficialWebsiteSubtitle =>
      'github.com/JackLeeo/midu からダウンロードしてインストール';
  ...
  @override
  String get importIosSharedDocuments => 'このiPhone内 · 米読';

  @override
  String get importICloudDrive => 'iCloud Drive · 米読';
  ...
  String get agreementV2HeroBody =>
      'MiDu はオープンソース・クロスプラットフォーム・ローカルファーストの電子書籍リーダーです。読書のための機能を提供しますが、あなたが取り込んだ書籍を提供・ホスティング・審査することはありません。';
  ...
  String get agreementV2ImportantNotice =>
      '重要：MiDu の公式版にはサードパーティの書籍ソースはプリインストール、内蔵、推奨されておらず、開発者がそのコンテンツを運営、代理、ホスティングすることもありません。取り込むファイルと追加するソースはご自身で選択し、権利のあるコンテンツだけを利用してください。';
  ...
  String get agreementV2SourceBoundaryPoint1 =>
      '公式プロジェクトが提供するのはオープンソースの閲覧ソフトウェアだけであり、ソースのアドレスや公式一覧は提供しません。';
  ...
  String get agreementV2Section1Body =>
      '本規約は、MiDu ソフトウェアおよび付属機能のダウンロード・インストール・使用に適用されます。「同意して続ける」をタップすることで、本規約を読み、理解し、同意したものとみなされます。同意しない場合は、使用を中止しアプリを終了してください。お住まいの地域の法律が定める同意年齢に達していない場合は、保護者が内容を読み同意する必要があります。';
  ...
  String get agreementV2Section2Body =>
      'ライセンスに従って使用・複製・改変・頒布・販売できますが、改変版を頒布する場合は完全な対応ソースを AGPL-3.0 で提供し、改変版をネットワークサービスとして提供する場合も利用者に対応ソースを提供する必要があります。v1.0.0 以前に付与された MIT License の権利は引き続き有効で撤回されません。本規約はオープンソースライセンスが付与する権利を制限せず、サードパーティコンポーネントには各自のライセンスが適用されます。';
  ...
  String get agreementV2ExitDialogBody =>
      'MiDu を利用するには利用規約への同意が必要です。同意しない場合はアプリを終了してください。';
