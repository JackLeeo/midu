...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get bookSourcesNoOfficialSourcesNotice =>
      'MiDu includes no sources and does not operate, recommend, or endorse third-party source services. Every source address is added by you.';
  ...
  String get bookSourcesRightsUnverifiedNotice =>
      'These statements are supplied by the independent source operator. MiDu displays them for transparency but does not verify or endorse them.';
  ...
  @override
  String get settingsQqChannelSubtitle => 'MiDu';
  ...
  @override
  String get agreementWelcomeTitle => 'Welcome to MiDu';
  ...
  String get settingsOfficialWebsiteSubtitle =>
      'Download and install from github.com/JackLeeo/midu';
  ...
  String get agreementV2HeroBody =>
      'MiDu is an open-source, cross-platform, local-first ebook reader. It provides reading tools; it does not provide, host, or review books you import.';
  ...
  @override
  String get agreementV2Subtitle => 'Please read before using MiDu';

  @override
  String get agreementV2ImportantNotice =>
      'Important: The official MiDu app does not preinstall, bundle, or recommend any third-party book source, and its developers do not operate, represent, or host source content. You choose every imported file and source you add; use only content you are authorized to access.';
  ...
  String get agreementV2Section1Body =>
      'These terms apply to your download, installation, and use of MiDu and its included features. By selecting “Agree and continue,” you confirm that you have read, understood, and accepted them. If you do not agree, stop using and exit the app. A guardian must consent where required by local law.';
  ...
  String get agreementV2ExitDialogBody =>
      'You must accept the Terms of Use to continue using MiDu. If you do not agree, please exit the app.';
