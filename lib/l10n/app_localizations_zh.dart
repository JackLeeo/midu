...
class AppLocalizationsZh extends AppLocalizations {
  ...
  String get bookSourcesNoOfficialSourcesNotice =>
      '米读不预装任何书源，也不运营、推荐或背书第三方书源服务。每个书源地址都由你主动添加。';
  ...
  String get bookSourcesRightsUnverifiedNotice =>
      '上述信息由独立书源运营者自行声明。米读仅为提高透明度而展示，不负责核验，也不构成推荐或背书。';
  ...
  @override
  String get agreementWelcomeTitle => '欢迎使用米读';
  ...
  @override
  String get firstHomeSupportPaperSemanticLabel => '米读开发者的自愿支持说明';
  ...
  String get settingsSupportDevelopmentCardSubtitle =>
      '开发和维护投入了大量时间与精力。如果米读对你有帮助，欢迎自愿捐赠支持。';
  ...
  String get settingsOfficialWebsiteSubtitle =>
      '从 github.com/JackLeeo/midu 下载并安装';
  ...
  String get agreementV2HeroBody =>
      '米读是一款开源、跨平台、本地优先的电子书阅读工具。它提供阅读能力，但不提供、托管或审核你导入的书籍。';
  ...
  String get agreementV2ImportantNotice =>
      '特别提示：米读官方版本不预装、不内置、不推荐任何第三方书源，也不运营、代理或托管书源内容。你导入的文件和主动添加的书源均由你自行选择；请仅访问和使用你有权使用的内容。';
  ...
  String get agreementV2Section1Body =>
      '本协议适用于你对米读软件及其附带功能的下载、安装和使用。点击“同意并继续”即表示你已阅读、理解并同意本协议；如你不同意，请停止使用并退出应用。若你未达到所在地法律规定的独立同意年龄，应由监护人阅读并同意。';
  ...
  @override
  String get agreementV2ExitDialogBody => '你需要同意使用条款后才能继续使用米读。若不同意，请退出应用。';
...
class AppLocalizationsZhTw extends AppLocalizationsZh {
  ...
  @override
  String get bookSourcesNoOfficialSourcesNotice =>
      '米讀不預載任何書源，也不營運、推薦或背書第三方書源服務。每個書源位址都由你主動新增。';
  ...
  @override
  String get bookSourcesRightsUnverifiedNotice =>
      '上述資訊由獨立書源營運者自行聲明。米讀僅為提高透明度而顯示，不負責核驗，也不構成推薦或背書。';
  ...
  @override
  String get agreementWelcomeTitle => '歡迎使用米讀';
  ...
  @override
  String get firstHomeSupportPaperSemanticLabel => '米讀開發者的自願支持說明';
  ...
  @override
  String get settingsSupportDevelopmentCardSubtitle =>
      '開發與維護投入了大量時間和心力。如果米讀對你有幫助，歡迎自願捐贈支持。';
  ...
  @override
  String get settingsOfficialWebsiteSubtitle =>
      '從 github.com/JackLeeo/midu 下載並安裝';
  ...
  @override
  String get agreementV2HeroBody =>
      '米讀是一款開源、跨平台、本機優先的電子書閱讀工具。它提供閱讀能力，但不提供、代管或審核你匯入的書籍。';
  ...
  @override
  String get agreementV2ImportantNotice =>
      '特別提示：米讀官方版本不預載、不內建、不推薦任何第三方書源，也不營運、代理或代管書源內容。你匯入的檔案和主動新增的書源均由你自行選擇；請僅存取和使用你有權使用的內容。';
  ...
  @override
  String get agreementV2Section1Body =>
      '本協議適用於你對米讀軟體及其附帶功能的下載、安裝和使用。點擊「同意並繼續」即表示你已閱讀、理解並同意本協議；如你不同意，請停止使用並離開應用程式。若你未達到所在地法律規定的獨立同意年齡，應由監護人閱讀並同意。';
  ...
  @override
  String get agreementV2ExitDialogBody => '你需要同意使用條款後才能繼續使用米讀。若不同意，請離開應用程式。';
