...
import 'package:midu/pages/home/widgets/home_bounce_navigation_item.dart';
import 'package:midu/pages/home/widgets/home_navigation_item.dart';
...
String _destinationLabel(
  ...
  return switch (destination) {
    ...
    HomeNavigationDestination.rss => l10n.rss,
...
IconData _destinationIcon(HomeNavigationDestination destination) {
  return switch (destination) {
    ...
    HomeNavigationDestination.rss => Icons.rss_feed_rounded,
