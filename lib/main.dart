...
class MiduApp extends StatefulWidget {
  const MiduApp({super.key, this.initialFilePaths = const []});

  final List<String> initialFilePaths;

  @override
  State<MiduApp> createState() => _MiduAppState();
}

class _MiduAppState extends State<MiduApp> with WidgetsBindingObserver {
